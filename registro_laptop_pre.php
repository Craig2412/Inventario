...
<body>
	...
	<div class="container col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<form class="form col-lg-12 col-md-12 col-sm-12 col-xs-12 col-xf-12" action="direccionamiento3.php" method="post">
            ...
            <div>
                ...
                <label for="control_01" class="label-checkbox">
                    <h2>Asignado</h2>
                    <p>Selecione si la LAPTOP esta asignado a algun funcionario</p>
                </label>
                </div>
            </section>
